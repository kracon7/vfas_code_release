...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--test_split',
                            type=float,
                            default=0.1,
                            help='Ratio of full dataset which is reserved as test data')
        self.parser.add_argument('--total_num_objs',
                            type=int,
                            default=-1,
                            help='How many objs to use when loading the dataset')
        self.parser.add_argument('--positive_grasps_ratio',
                            type=float,
                            default=0.5,
                            help='Ratio of positive grasps to be sampled for training data')
        self.parser.add_argument('--hard_negative_grasps_ratio',
                            type=float,
                            default=0.3,
                            help='Ratio of hard negative grasps to be sampled for training data')
