...
gripper_mesh = o3d.io.read_triangle_mesh(
                "resources/2f85_open_grasp_frame.stl")
gripper_mesh.compute_vertex_normals()
pcd = gripper_mesh.sample_points_uniformly(number_of_points=2500)
...
pcd_cropped = pcd_cropped.farthest_point_down_sample(300)
...
torch.save(pts_tensor, 'resources/2f85_open.pt')