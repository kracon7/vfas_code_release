...
package_name = 'motion_field'
submodules = ['motion_field/gmflow', 'motion_field/gmflow_utils']
...
setup(
    ...
    zip_safe=True,
    maintainer='markbench',
    maintainer_email='p.piacenza@samsung.com',
    description='TODO: Package description',
    license='TODO: License declaration',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'gmflow_node = motion_field.gmflow_node:main'
        ],
    },
)
